# 渲染预设：创建/应用渲染预设空物体、场景间同步渲染设置、打开各类文件夹
# （合并自 Bekkan/STOOL_part/RenderOps.py，纯平移；面板在 ui/bekkan/panels.py）
import os
from bpy.props import (StringProperty, IntProperty, PointerProperty,  # type: ignore
                       BoolProperty)
...
# 插件根目录（core/render_preset.py 上两级 = 包根）
